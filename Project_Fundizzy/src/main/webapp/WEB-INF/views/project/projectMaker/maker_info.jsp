...
<body>
	...
	<div class="main"> 
	    ...
	    <div class="container">
	        ...
	        <input type="text" id="maker-name" placeholder="메이커 명을 입력해 주세요">
	
	        <small>40자 제한</small>
	
	        <label>메이커 프로필 이미지</label>
	        <button class="image-upload">이미지 등록</button>
	        ...
	        <label>SNS(선택)</label>
	        <input type="text" placeholder="facebook 주소 입력">
	        <input type="text" placeholder="twitter 주소 입력">
	        <input type="text" placeholder="instagram 주소 입력">
	    </div>
    </div>
</body>
</html>
