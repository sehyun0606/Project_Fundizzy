...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/myPage/supporter/pay_transfer_result.css">
<body>
	...
	<div class="pay-container">
		<div class="pay-info">
			...
			<span id="span1">내 계좌로 <fmt:formatNumber pattern="#,###원 " value="${map.tran_amt}"></fmt:formatNumber>송금완료!</span><br>
