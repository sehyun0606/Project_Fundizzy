		            ...
		            <tbody>
		            	<c:forEach var="project" items="${projectList}" varStatus="status">
			                    <tr>
			                        ...
			                        <td><img class="project_img" alt="" src="${project.representative_picture}" style="height: 100px;"></td>
			    ...
			    <div class="page_btn">
			        <c:if test="${pageInfo.maxPage != 0}">
			            ...
			            <c:choose>
			                ...
			                <c:otherwise>
			                    <a href="AdminProjectList?pageNum=${pageInfo.pageNum - 1}">이전</a>
			                </c:otherwise>
			            </c:choose>
			            ...
			            <c:forEach var="i" begin="${pageInfo.startPage}" end="${pageInfo.endPage}">
			                <c:choose>
			                    ...
			                    <c:otherwise>
			                        <a href="AdminProjectList?pageNum=${i}">${i}</a>
			                    </c:otherwise>
			                </c:choose>
			            </c:forEach>
			            ...
			            <c:choose>
			                ...
			                <c:otherwise>
			                    <a href="AdminProjectList?pageNum=${pageInfo.pageNum + 1}">다음</a>
			                </c:otherwise>
			            </c:choose>
			        </c:if>
			    </div>
